...
class LoginVC: UIViewController ,UITextFieldDelegate{
    ...
    let loginRegisterGuestSegmentedControl:UISegmentedControl = {
        ...
        sc.tintColor = UIColor(red: 250/255, green: 94/255, blue: 0/255, alpha: 1)
    ...
    var nameTextField:UITextField = {
        ...
        tf.textColor = UIColor(red: 250/255, green: 94/255, blue: 0/255, alpha: 1)
    ...
    var loginRegisterGuestButton:UIButton = {
        ...
        button.backgroundColor = UIColor(red: 250/255, green: 94/255, blue: 0/255, alpha: 1)
